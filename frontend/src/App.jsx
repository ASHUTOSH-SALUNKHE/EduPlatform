...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#151515] text-gray-200 font-sans selection:bg-blue-600 selection:text-white">
      ...
      {/* Navigation */}
      <nav className="sticky top-0 z-50 bg-[#151515]/90 backdrop-blur-md border-b border-gray-800">
      ...
      <section className="relative overflow-hidden pt-16 pb-24 lg:pt-32 lg:pb-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-20 pt-8">
      ...
      <section className="py-20 bg-[#151515] border-t border-gray-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl border border-gray-800">
            {/* Placeholder for video embed. Replace src with actual video thumbnail or iframe. */}
            <img
      ...
      <section className="bg-[#1a1a1a] py-20 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#202020] p-8 rounded-2xl border border-gray-700/50 hover:border-blue-500/50 transition-colors">
